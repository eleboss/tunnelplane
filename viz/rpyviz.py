...
with open('/home/eleboss/Documents/tunnelplane/viz/fly_data_20180927_1635_ex1.txt', 'r') as f:
    lines = f.readlines()
jumper = 0
yaw, pitch, roll = [], [], []
x, y, z = [], [], []
...
print 'The std of x:',np.std(np.array(x[1000:4500]),ddof = 1)
print 'The std of y:',np.std(np.array(y[1000:4500]),ddof = 1)
...
plt.subplot(511)
plt.plot(t, roll[800:4500])
plt.ylabel("Roll (rad)") 

plt.subplot(512)
plt.plot(t, pitch[800:4500])
plt.ylabel("Pitch (rad)") 

plt.subplot(513)
plt.plot(t, x[800:4500])
plt.ylabel("X Position (m)") 

plt.subplot(514)
plt.plot(t, y[800:4500])
plt.ylabel("Y Position (m)") 

plt.subplot(515)
plt.plot(t, z[800:4500])
